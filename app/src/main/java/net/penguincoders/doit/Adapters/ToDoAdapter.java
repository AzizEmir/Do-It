...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ViewHolder> {
    ...
    public void editItem(int position) {
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                jsonHelper.updateTask(item.getId(), newText);
    ...
    private void loadTasksFromJson() {
        try {
            InputStream inputStream = context.getAssets().open("tasks.json");
    ...
    private void saveTasksToJson() {
        ...
        try {
            OutputStream outputStream = context.openFileOutput("tasks.json", Context.MODE_PRIVATE);
